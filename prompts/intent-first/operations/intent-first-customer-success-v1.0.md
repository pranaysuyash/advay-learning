...
**Codebase-First Focus:** Build on existing customer relationships. Enhance current support processes before creating new ones.
...
- **Process Fit**: Can existing processes handle this?
...
- **Existing processes can handle this adequately**
...
| Customer Impact | Relationship Impact | Resource Efficiency | Existing Process | Priority |
|----------------|-------------------|-------------------|------------------|----------|
| High | High | High | Needs Improvement | **Critical – Address immediately with enhanced solution** |
| High | Medium | High | Needs Improvement | **High – Resolve this week with improved process** |
| Medium | High | High | Needs Improvement | **Medium – Plan for next sprint with team involvement** |
| High | High | Low | Needs Improvement | **Escalate for resource allocation or process improvement** |
| Low | Low | Any | Adequate | **Provide standard resolution, monitor for patterns** |
...
4. **Build on relationships** - deepen existing connections
5. **Measure outcomes** - track if interventions actually help customers succeed
...
2. **Existing Process Review**:
   - What processes already exist for this type of issue?
   - How could current processes be enhanced?
...
5. **Solution Options**:
   - Immediate resolution using existing processes
   - Enhanced process for this and similar issues
...
- Enhance existing processes before creating new ones
```
...
- **"Can existing processes handle this, or do we need new ones?"**

---

## Related

- See `intent-first-sales-v1.0.md` for sales handoffs
- See `intent-first-product-v1.0.md` for product feedback integration
