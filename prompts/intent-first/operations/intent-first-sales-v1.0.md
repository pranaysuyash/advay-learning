...
**Codebase-First Focus:** Build on existing sales processes. Enhance current pipeline stages before adding new ones.
...
- **Process Fit**: How well do they fit existing sales motion?
...
- **Don't fit existing sales process (high customization needed)**
...
| Success Probability | Revenue Quality | Strategic Value | Process Fit | Priority |
|-------------------|----------------|----------------|-------------|----------|
| High | High | High | Strong | **Critical – Full sales engagement with executive involvement** |
| High | Medium | Medium-High | Strong | **High – Standard sales process with success planning** |
| Medium | High | Medium | Moderate | **Medium – Qualify thoroughly before significant investment** |
| High | High | Low | Strong | **Evaluate resource allocation vs. other opportunities** |
| Low | Any | Any | Weak | **Provide self-service options, minimal sales investment** |
...
4. **Qualify rigorously** - ensure fit before customizing process
5. **Measure conversion** - track what actually leads to closed deals
...
2. **Existing Pipeline Review**:
   - What stage is this opportunity in?
   - What interactions have already occurred?
   - What materials have they seen?

3. **Success Fit Assessment**:
...
- Use existing sales processes and materials where possible
```
...
- **"Does our standard process work for you, or do you need customization?"**

---

## Related

- See `intent-first-customer-success-v1.0.md` for post-sale success
- See `intent-first-product-v1.0.md` for product-market fit
