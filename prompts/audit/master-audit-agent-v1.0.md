...
That prompt will force the agent to behave like a real auditor instead of a vibe-based reviewer.

Also, if this repo is related to your antigravity/gemini worktree, this prompt already fits. It will naturally pick up FastAPI/React boundaries, MediaPipe usage, and any agent pipelines if they exist.
