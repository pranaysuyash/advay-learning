...
1. **Add game thumbnails** to cards
2. **Replace progress bars** with visual rewards
3. **Localize landing page** for regional users
4. **Improve empty states** (zeros → encouragement)

### P2: Nice to Have

1. **Animate game cards** on hover
2. **Add character reactions** to progress
3. **Seasonal themes** for dashboard
4. **Parent tutorial** overlay
