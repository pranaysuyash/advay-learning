...
2. **Create semantic color system** - Define theme colors for consistency
3. **Differentiate action buttons** - Make primary/secondary actions visually distinct
4. **Simplify language names** - Use flags or simplified text

### Could Fix (P2)

9. **Add celebration animations** - Make stats more engaging
2. **Create StatCard component** - Reusable stats with better UX
3. **Add progress visualization** - Fun graphs or journeys
