...
| ISSUE-003 | OPEN | Apply comprehensive rate limiting to auth endpoints | TBD |
| ISSUE-004 | OPEN | Strengthen password policy enforcement | TBD |
| ISSUE-005 | OPEN | Secure session management (rotation/fixation) | TBD |
| ISSUE-006 | OPEN | Add security headers to API responses | TBD |
...
| OBS-001 | OPEN | Implement structured logging (JSON) using structlog | TBD |
