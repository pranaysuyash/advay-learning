# Brand Architecture: ADVAY + Pip (Complete)

**Dual-brand system documentation - Final version**
...
|---------|-------|
| **Product Name** | Advay |
| **Official Expansion** | Active Discovery Vision AI for Youth |
| **Mascot** | Pip the Red Panda |
| **Mascot Expansion** | Playful Interactive Partner |
| **Sanskrit Meaning** | Unique / One of a kind |
...
- Error handling (gentle corrections)
- Progress rewards (badges, streaks)
...
| Advay Slate | #2D3748 | Text, tech, wordmark | Professional |
| Discovery Cream | #FFF8F0 | Backgrounds, cards | Pip's belly |
| Vision Blue | #3B82F6 | AI features, links | Tech accent |
...
Guided by Pip, your Playful Interactive Partner
```

**Social:** Just Pip's face for icon recognition
...
4. Point Right - navigation
5. Thumbs Up - success
6. Thinking - try again
7. Celebrate - big win
8. Sleepy - break time
9. Listen - voice mode
10. Stop - parent gate
...
- Transparent backgrounds (SVG + PNG)
...
## Part 7: Naming Consistency

| Element | Format | Example |
|---------|--------|---------|
| Product | Advay (title case) | "Use Advay for 10 minutes daily" |
| Mascot | Pip (title case) | "Pip says great job!" |
| Full mascot | "Pip the Red Panda" | Used once on About page |
| Acronym | All caps when expanded | "Active Discovery Vision AI for Youth" |
...
| | ADVAY | Pip |
|--|-------|-----|
| Represents | Technology, Education, Trust | Fun, Friendship, Engagement |
| Audience | Parents, Investors, Schools | Kids (ages 3-8) |
| Tone | Smart, Advanced, Caring | Playful, Encouraging, Concrete |
| Color | Slate #2D3748 | Orange #E85D04 |
| Acronym | Active Discovery Vision AI for Youth | Playful Interactive Partner |
| Role | The Platform | The Companion |

---

## Part 10: Implementation Checklist

- [x] Brand name locked: Advay
- [x] Acronym locked: Active Discovery Vision AI for Youth
- [x] Mascot locked: Pip the Red Panda
- [x] Mascot meaning: Playful Interactive Partner
- [x] Color palette defined
- [ ] Logo design (wordmark + Pip icon)
- [ ] Domain purchase
- [ ] Social handles secured
- [ ] Pip asset pack (28 assets)
- [ ] Brand guidelines PDF
- [ ] Pitch deck integration

---

**Status:** Brand architecture complete
**Last Updated:** 2026-01-30
**Version:** 1.0

*Part 2 of Brand Naming Exploration*
