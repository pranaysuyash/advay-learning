...
class Profile(Base):
    ...
    progress: Mapped[list["Progress"]] = relationship("Progress", back_populates="profile", lazy="selectin")
    achievements: Mapped[list["Achievement"]] = relationship("Achievement", back_populates="profile", lazy="selectin")
