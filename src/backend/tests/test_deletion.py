...
class TestProfileDeletion:
    ...
    async def test_delete_profile_requires_password(self, client: AsyncClient, auth_headers: dict):
    ...
    async def test_delete_profile_wrong_password(self, client: AsyncClient, auth_headers: dict):
    ...
    async def test_delete_profile_success(self, client: AsyncClient, test_user: dict, auth_headers: dict):
    ...
    async def test_delete_other_users_profile_fails(self, client: AsyncClient, auth_headers: dict):
...
class TestAccountDeletion:
    ...
    async def test_delete_account_requires_password(self, client: AsyncClient, auth_headers: dict):
    ...
    async def test_delete_account_success(self, client: AsyncClient, test_user: dict, auth_headers: dict):
...
class TestAuditLogging:
    ...
    async def test_profile_deletion_logged(self, client: AsyncClient, test_user: dict, auth_headers: dict, db_session):
        ...
        # Check audit log
        logs = await AuditService.get_resource_actions(db_session, "profile", profile_id)
        assert len(logs) >= 1
    ...
    async def test_failed_deletion_logged(self, client: AsyncClient, auth_headers: dict, db_session):
        ...
        async with async_session() as session:
            logs = await AuditService.get_resource_actions(session, "profile", profile_id)
