/**
 * Math Smash Game - REFACTORED with GameShell
 * 
...
const MathSmashGame = memo(function MathSmashGameComponent() {
...
export const MathSmash = memo(function MathSmashComponent() {
  return (
    <GameShell
      gameId="math-smash"
      gameName="Math Smash"
