...
export function Progress() {
  ...
  const { metrics, scorecard, honestStats, plantGrowth } = useProgressMetrics(progress);
      ...
      >
        ...
        <div className='flex justify-between items-center mb-8'>
          <div>
            ...
            <p className='text-white/60 mt-1'>Track growth and celebrate achievements</p>
          </div>
          ...
          <>
            ...
            <div className='bg-white/10 border border-border rounded-xl p-8 mb-8'>
              <div className='text-center mb-6'>
                <h2 className='text-2xl font-bold text-white mb-2'>Your Learning Garden</h2>
                <p className='text-white/60'>Watch your knowledge grow with every practice session</p>
              </div>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 items-center'>
                ...
                <div className='space-y-4'>
                  <div className='bg-white/5 border border-border rounded-lg p-4'>
                    <h3 className='font-semibold text-white mb-2'>Growth Stage: {plantGrowth.stage}</h3>
                    <p className='text-sm text-white/80 mb-3'>
                      {plantGrowth.stage === 'seed' && "Your learning journey has just begun! Every practice helps the seed sprout."}
                      {plantGrowth.stage === 'sprout' && "Great progress! Your plant is growing stronger with each activity."}
                      {plantGrowth.stage === 'young' && "Wonderful growth! Your plant is developing leaves and getting ready to mature."}
                      {plantGrowth.stage === 'mature' && "Excellent work! Your plant is strong and ready to bloom with knowledge."}
                      {plantGrowth.stage === 'blooming' && "Amazing! Your plant is in full bloom, showcasing your learning achievements."}
                    </p>
                  ...
                  <div className='text-center'>
                    <div className='text-3xl font-bold text-white mb-1'>{scorecard.overallScore}/100</div>
            ...
            <div className='mb-8'>
              <h2 className='text-2xl font-bold text-white mb-6'>Learning Dimensions</h2>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8'>
              ...
              <div className='bg-white/10 border border-border rounded-xl p-6'>
                <h3 className='text-xl font-semibold text-white mb-4 flex items-center gap-2'>
                  <UIIcon name='sparkles' size={20} className='text-yellow-400' />
                  Insights
                </h3>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8'>
              ...
              <div className='bg-white/10 border border-border rounded-xl p-6'>
                ...
                <div className='space-y-3'>
                  {scorecard.areasForImprovement.map((area: string, i: number) => (
                    <RecommendationCard
                      key={i}
                      type="improvement"
                      title="Focus Area"
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
              <div className='bg-white/10 border border-border rounded-xl p-6 text-center'>
                ...
                <div className='text-white/60 text-sm'>Unique Letters Practiced</div>
              </div>
              <div className='bg-white/10 border border-border rounded-xl p-6 text-center'>
                <div className='text-3xl font-bold text-white mb-1'>
                  {honestStats.avgTracingAccuracy}%
                </div>
                <div className='text-white/60 text-sm'>Average Tracing Accuracy</div>
              </div>
              <div className='bg-white/10 border border-border rounded-xl p-6 text-center'>
                <div className='text-3xl font-bold text-white mb-1'>
