          ...
          <div className='bg-white/5 border border-white/10 rounded-xl p-6'>
            ...
            <div className='space-y-4'>
              ...
              <div className='text-sm text-white/50 bg-white/5 rounded-lg p-3'>
                <strong className='text-white/70'>Privacy:</strong> Camera data
                is processed locally on your device. No video is sent to our
                servers.
              </div>
            </div>
          </div>
          ...
          <div className='bg-white/5 border border-white/10 rounded-xl p-6'>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex items-center justify-between bg-white/5 border border-white/20 rounded-lg px-4 py-3'>
                ...
                <button
                  onClick={() =>
                    settings.updateSettings({ showHints: !settings.showHints })
                  }
                  aria-label={
                    settings.showHints
                      ? 'Hide letter hints'
          ...
          <div className='bg-white/5 border border-white/10 rounded-xl p-6'>
            ...
            <div className='space-y-4'>
              ...
              <button
                ...
                onClick={() => {
                  if (
                    confirm('Reset all letter progress? This cannot be undone.')
                  ) {
            ...
            {showUnlockConfirm && (
              <div className='mt-4 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg'>
                <p className='text-yellow-300 mb-3'>
                  ⚠️ This will unlock all letters immediately. Your child will
                  skip the progressive learning experience.
                </p>
