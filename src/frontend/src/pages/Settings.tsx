        ...
        {parentGatePassed && (
          <>
            <div className="mb-10 text-center relative z-10">
              ...
              <p className="text-xl text-text-secondary font-bold mt-4">Manage learning preferences, tools, and parent controls.</p>
            </div>
                ...
                <div className='bg-white border-3 border-[#F2CC8F] rounded-[2.5rem] shadow-[0_4px_0_#E5B86E] overflow-hidden'>
                  <div className="bg-[#3B82F6] px-8 py-5 border-b-4 border-blue-600">
                    <h2 className='text-2xl font-black text-white flex items-center gap-3 drop-shadow-[0_2px_2px_rgba(0,0,0,0.1)]'>
                      ...
                      {t('settings:sections.learning')}
                    </h2>
                  </div>
                  <div className='p-8 space-y-8'>
                    <div>
                      <label className='block font-black text-advay-slate mb-3 text-lg'>
              ...
              <div className="space-y-8">
                ...
                <div className='bg-white border-3 border-[#F2CC8F] rounded-[2.5rem] shadow-[0_4px_0_#E5B86E] overflow-hidden'>
                  ...
                  <div className='p-8 space-y-8'>
                    ...
                    <div className='flex items-center justify-between pt-6 border-t-4 border-[#F2CC8F]'>
                      <div>
                        <div className='font-black text-advay-slate text-lg'>Show Tracing Hints</div>
                        <div className='text-base font-bold text-text-secondary mt-1'>Visual guides for drawing</div>
                      </div>
                      <button
                    ...
                    {user ? (
                      <div className='flex items-center justify-between mb-4'>
                        <div>
                          ...
                          <p className="font-bold text-xl text-advay-slate">{user.email}</p>
                        </div>
                        <Button
                          variant="secondary"
