            ...
            >
              ...
              >
                ...
                <div className='text-center mb-8 pt-4'>
                  <div className='w-20 h-20 bg-white border-3 border-[#3B82F6] shadow-[0_4px_0_#E5B86E] rounded-full flex items-center justify-center text-4xl mx-auto mb-4 -mt-12'>👋</div>
