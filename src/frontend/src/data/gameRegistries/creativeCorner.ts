...
export const DOODLE_DOCK_GAMES: GameManifest[] = [
  // ── Doodle Dock ───────────────────────────────────────────────────
  {
    ...
    previewImage: '/assets/previews/connect-the-dots-preview.png',
...
export const ART_ATELIER_GAMES: GameManifest[] = [
  // ── Art Atelier ───────────────────────────────────────────────────
  {
    ...
    icon: 'sparkles',
    previewImage: '/assets/previews/air-canvas-preview.png',
    worldId: 'art-atelier',
    vibe: 'creative',
    ageRange: '3-8',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'sparkles',
    previewImage: '/assets/previews/mirror-draw-preview.png',
    worldId: 'art-atelier',
    vibe: 'chill',
    ageRange: '4-7',
    isNew: true,
...
export const CREATIVE_CORNER_GAMES: GameManifest[] = [
  ...
  // ── Finger Painting Madness ─────────────────────────────────────────
  {
    ...
    cv: ['hand'],
    listed: true,
    previewImage: '/assets/previews/finger-painting-madness-preview.png',
    drops: [
      { itemId: 'color-rainbow', chance: 0.15 },
      { itemId: 'tool-paintbrush', chance: 0.2 },
    ],
