...
export const NUMBER_JUNGLE_GAMES: GameManifest[] = [
  // ── Number Jungle ─────────────────────────────────────────────────
  {
    ...
    icon: 'hand',
    previewImage: '/assets/previews/finger-counting.png',
  ...
  },
  {
    ...
    icon: 'circle',
    previewImage: '/assets/previews/number-tap-trail.png',
    worldId: 'number-jungle',
    vibe: 'active',
    ageRange: '4-8',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'pencil',
    previewImage: '/assets/previews/number-tracing.png',
    worldId: 'number-jungle',
    vibe: 'chill',
    ageRange: '4-7',
    isNew: true,
...
export const NUMBER_JUNGLE_EXTRA_GAMES: GameManifest[] = [
  // ── Number Jungle (Additional) ────────────────────────────────────
  {
    ...
    icon: 'hand',
    previewImage: '/assets/previews/math-monsters.png',
    worldId: 'number-jungle',
    vibe: 'brainy',
    ageRange: '5-8',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'target',
    previewImage: '/assets/previews/math-jumpers.png',
    worldId: 'number-jungle',
    vibe: 'active',
    ageRange: '4-7',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'plus',
    previewImage: '/assets/previews/simple-addition.png',
    worldId: 'number-jungle',
    vibe: 'educational',
    ageRange: '4-7',
    isNew: true,
