...
export const NUMBER_JUNGLE_GAMES: GameManifest[] = [
  // ── Number Jungle ─────────────────────────────────────────────────
  {
    ...
    icon: 'hand',
    previewImage: '/assets/previews/finger-counting-v2.png',
  ...
  },
  {
    ...
    icon: 'circle',
    previewImage: '/assets/previews/number-tap-trail-v2.png',
    worldId: 'number-jungle',
    vibe: 'active',
    ageRange: '4-8',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'pencil',
    previewImage: '/assets/previews/number-tracing-v2.png',
    worldId: 'number-jungle',
    vibe: 'chill',
    ageRange: '4-7',
    isNew: true,
...
export const NUMBER_JUNGLE_EXTRA_GAMES: GameManifest[] = [
  // ── Number Jungle (Additional) ────────────────────────────────────
  {
    ...
    icon: 'hand',
    previewImage: '/assets/previews/math-monsters-v2.png',
    worldId: 'number-jungle',
    vibe: 'brainy',
    ageRange: '5-8',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'target',
    previewImage: '/assets/previews/math-jumpers-v2.png',
    worldId: 'number-jungle',
    vibe: 'active',
    ageRange: '4-7',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'plus',
    previewImage: '/assets/previews/simple-addition-v2.png',
    worldId: 'number-jungle',
    vibe: 'educational',
    ageRange: '4-7',
    isNew: true,
