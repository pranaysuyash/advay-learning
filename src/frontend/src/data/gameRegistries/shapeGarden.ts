...
export const SHAPE_GARDEN_GAMES: GameManifest[] = [
  // ── Shape Garden ──────────────────────────────────────────────────
  {
    id: 'shape-pop',
    name: 'Shape Pop',
    tagline: 'Pop the shapes that match Pip’s request! 🎈◻️',
    path: '/games/shape-pop',
    icon: 'star',
    previewImages: [
      '/assets/previews/shape-pop-v1.png',
      '/assets/previews/shape-pop.png',
    ],
  ...
  },
  {
    ...
    icon: 'sparkles',
    previewImage: '/assets/previews/shape-sequence.png',
    worldId: 'mind-maze',
    vibe: 'brainy',
    ageRange: '4-8',
    isNew: true,
...
export const SHAPE_GARDEN_EXTRA_GAMES: GameManifest[] = [
  // ── Shape Garden (Additional) ─────────────────────────────────────
  {
    ...
    icon: 'target',
    previewImages: [
      '/assets/previews/shape-safari-v1.png',
      '/assets/previews/shape-safari.png',
    ],
    worldId: 'shape-garden',
    vibe: 'creative',
    ageRange: '3-5',
