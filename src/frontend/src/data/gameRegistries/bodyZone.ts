...
export const BODY_ZONE_GAMES: GameManifest[] = [
  // ── Body Zone ─────────────────────────────────────────────────────
  {
    ...
    icon: 'sparkles',
    previewImage: '/assets/previews/yoga-animals.png',
    worldId: 'body-zone',
    vibe: 'chill',
    ageRange: '3-8',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'sparkles',
    previewImage: '/assets/previews/balloon-pop-fitness-preview.png',
    worldId: 'body-zone',
    vibe: 'active',
    ageRange: '3-8',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'sparkles',
    previewImage: '/assets/previews/obstacle-course-preview.png',
    worldId: 'body-zone',
    vibe: 'active',
    ageRange: '4-7',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'sparkles',
    previewImage: '/assets/previews/follow-the-leader-preview.png',
    worldId: 'body-zone',
    vibe: 'active',
    ageRange: '3-8',
    isNew: true,
  ...
  },
  {
    ...
    icon: 'music',
    previewImage: '/assets/previews/musical-statues-preview.png',
    worldId: 'body-zone',
    vibe: 'active',
    ageRange: '3-8',
    isNew: true,
  ...
  {
    id: 'midline-violator',
    name: 'Midline Violator',
    tagline: 'Cross the line! Hit right targets with left hand and vice-versa. 🤸‍♂️✨',
